    ...
    bowercopy: {
      ...
      scripts: {
        ...
        files: {
          ...
          // 'pines-notify/js/jquery.pnotify.min.js': '',
          'moment/js/moment-with-langs.min.js': 'moment/min/moment-with-locales.min.js',
          'handlebars/js/handlebars.js': 'handlebars/handlebars.js',
          'require-handlebars-plugin/js/i18nprecompile': 'require-handlebars-plugin/hbs/i18nprecompile.js',
          'require-handlebars-plugin/js/json2': 'require-handlebars-plugin/hbs/json2.js',
          'require-handlebars-plugin/js/hbs': 'require-handlebars-plugin/hbs.js',
